...
namespace dc
{
    public class KafkaConsumer : BusinessService
    {
        ...
        {
            Console.WriteLine("[.Net] ...Initialization started");
            ...
            Console.WriteLine("[.Net] ...Initialized!");
        }

        public override object OnProcessInput(object messageInput)
        {
            Console.WriteLine("[.Net] ...KafkaConsumer:OnProcessInput is called");
            bool atEnd = false;
        ...
        {
            iris.Close();
            Console.WriteLine("[.Net] ...KafkaConsumer:OnTearDown is called");
        }
    }
}
